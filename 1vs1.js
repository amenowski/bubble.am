...
function GameServer() {
  ...
  this.config = {
    ...
    serverPort: 234234, // Server port
    serverGamemode: 1, // Gamemode, 0 = FFA, 1 = Teams
    ...
    serverViewBaseY: 592,
    serverStatsPort: 8823, // Port for stats server. Having a negative number will disable the stats server.
    ...
    borderRight: 4500, // Right border of map (Vanilla value: 11180.3398875)
    borderTop: 0, // Top border of map (Vanilla value: 0)
    borderBottom: 4500, // Bottom border of map (Vanilla value: 11180.3398875)
    ...
    tourneyMaxPlayers: 2, // Maximum amount of participants for tournament style game modes
...
GameServer.prototype.start = function () {
  ...
  this.config.serverPort = process.env.PORT || 2345;
  // here
  // Start the server
...
GameServer.prototype.loadConfig = function () {
  try {
    ...
    var load = ini.parse(fs.readFileSync("./1vs1.ini", "utf-8"));
